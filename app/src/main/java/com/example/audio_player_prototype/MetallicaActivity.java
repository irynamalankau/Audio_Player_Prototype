...
public class MetallicaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        songList.add(new Song("Action This Day", "Metallica", "3:15"));
        songList.add(new Song("Coming Soon", "Metallica", "3:25"));
        songList.add(new Song("Dear Friends", "Metallica", "4:05"));
        songList.add(new Song("Delilah", "Metallica", "3:37"));
        songList.add(new Song("Drowse", "Metallica", "3:48"));
        songList.add(new Song("Love kills", "Metallica", "3:29"));
        songList.add(new Song("Misfire", "Metallica", "4:15"));
        songList.add(new Song("The night comes", "Metallica", "3:23"));
